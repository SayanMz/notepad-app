...
import 'package:notepad/features/note/services/voice_ai/formatting_target_resolver.dart';
...
void main() {
  test(
    'resolve returns the current selection for selection-based commands',
    () {
