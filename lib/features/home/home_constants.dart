...
class HomeConstants {
  ...
  static const double drawerHeaderPaddingH = 16.0;
  static const double drawerHeaderPaddingT = 16.0;
  static const double drawerHeaderPaddingB = 12.0;
  static const double drawerIconSize = 28.0;
  static const double drawerHeaderTitleFontSize = 18.0;
  static const double drawerHeaderStatusFontSize = 12.0;
  static const double drawerHeaderTightGap = 4.0;
  static const double drawerHeaderSectionGap = 10.0;
  static const double drawerHeaderBlockGap = 14.0;
  static const double drawerSectionGap = 8.0;
  ...
  static const double fabHorizontalPadding = 24.0;
  ...
  static const double selectionOverlayShadowBlur = 24.0;
  static const double selectionOverlayShadowOffsetY = 8.0;
