...
// Swipeable note row that handles open, pin, reorder, and delete interactions.
                        ...
                        child: Container(
                          ...
                          child: Builder(
                            builder: (context) {
                              ...
                              final double scale = _hasSnapped
                                  ? 1.1
                                  : (draggedPixels / lockPoint).clamp(0.5, 1.0);
                              final double iconOpacity =
                                  (draggedPixels / lockPoint).clamp(0.0, 1.0);
                  ...
                  return Dismissible(
                    ...
                    onUpdate: (details) {
                      ...
                      if (details.progress >= lockProgress && !_hasSnapped) {
                        ...
                        _hasSnapped = true;
                      } else if (details.progress < lockProgress &&
                          _hasSnapped) {
                        _hasSnapped = false;
                      }

                      if (details.progress == 0.0 ||
                          (details.progress - _dragProgress.value).abs() >
                              0.01) {
