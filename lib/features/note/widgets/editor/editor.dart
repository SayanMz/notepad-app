...
class _NoteEditorState extends State<NoteEditor> {
  ...
  TextStyle get _baseTextStyle => GoogleFonts.sourceSans3(
    ...
    color: isDark
        ? NoteConstants.editorTextColorDark
        : NoteConstants.editorTextColor,
  );

  // Swallow default Quill popups so our custom floating menu takes over completely
  ...
  void initState() {
    ...
    // Listen to cursor position changes & focus events
  ...
  void _checkCursorForLink() {
    ...
    // Dismiss menu if the user is making a multi-character highlight/selection
    ...
    if (linkAttr != null && linkAttr.value != null) {
      ...
      // Only rebuild and present the menu if navigating to a different link target
